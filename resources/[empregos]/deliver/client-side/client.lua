...
Citizen.CreateThread(function()
	local initList = {
		...
		{ 1588.67,6455.92,25.69,"PopsDiner",1.0,1.5,"Trabalhar" },
		{ 811.29,-751.93,26.85,"PizzaThis",0.75,1.5,"Trabalhar" }
	}
...
AddEventHandler("deliver:Starting",function(Init)
	if Cds[Init] then
		if Starting then
			...
			TriggerEvent("Notify","verde","Você Finalizou o trabalho.",5000)
			...
			TriggerEvent("Notify","verde","Você Iniciou o trabalho.",5000)
...
function DrawText(x,y,z,text,color)
	...
	if onScreen then
		...
		if color then
			DrawRect(_x,_y + 0.0125,width,0.03,255,204,0,200)
		else
