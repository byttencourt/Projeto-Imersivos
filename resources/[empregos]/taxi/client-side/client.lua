...
function generatePassenger(vehicle)
	...
	local myObject,objNet = vRPS.CreatePed(spawnModels[randModels],spawnPeds[locateSelect][selectPosition][1],spawnPeds[locateSelect][selectPosition][2],spawnPeds[locateSelect][selectPosition][3],180.00,4)
	if myObject then
