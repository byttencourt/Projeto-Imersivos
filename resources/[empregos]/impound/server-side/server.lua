...
AddEventHandler("impound:Check",function(entity)
	...
	if user_id then
		if impoundVehs[entity[2].."-"..entity[1]] == nil then
			...
			vRP.generateItem(user_id,"plastic",math.random(8,12),true)
			vRP.generateItem(user_id,"glass",math.random(8,12),true)
			vRP.generateItem(user_id,"rubber",math.random(8,12),true)
			vRP.generateItem(user_id,"aluminum",math.random(8,12),true)
			vRP.generateItem(user_id,"copper",math.random(6,10),true)
			vRP.generateItem(user_id,"dollars",math.random(750,1000),true)
...
RegisterCommand("placa",function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.hasGroup(user_id,"Police") or vRP.hasGroup(user_id,"Admin") and args[1] then
