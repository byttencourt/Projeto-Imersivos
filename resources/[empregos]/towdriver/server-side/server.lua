...
function cRP.paymentMethod()
	...
	if user_id then
		if (vRP.inventoryWeight(user_id) + 3) <= vRP.getWeight(user_id) then
			vRP.generateItem(user_id,"plastic",math.random(10,14),true)
			vRP.generateItem(user_id,"rubber",math.random(10,14),true)
			vRP.generateItem(user_id,"glass",math.random(10,14),true)
			vRP.generateItem(user_id,"aluminum",math.random(10,16),true)
			vRP.generateItem(user_id,"copper",math.random(10,16),true) 
		else
