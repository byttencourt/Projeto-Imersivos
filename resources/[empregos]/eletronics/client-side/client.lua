...
local atmList = {
	...
	{ 2555.2,389.95,108.61,357.17,"Sul" },
	...
	{ 821.5,-780.25,26.17,266.46,"Sul" },	
	{ 822.84,-825.91,26.32,277.8,"Sul" },
	{ 168.56,6636.81,31.69,226.78,"Norte "},
	...
	{ 1736.92,6413.27,35.03,246.24,"Norte" },
	{ 540.39,2667.84,42.16,96.38,"Norte" },
	{ 1966.75,3746.51,32.33,303.31,"Norte" },
	{ 2680.34,3288.47,55.23,328.82,"Norte" },
	...
	{ -2975.06,380.18,15.0,263.63,"Norte" }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADTARGET
-----------------------------------------------------------------------------------------------------------------------------------------
Citizen.CreateThread(function()
	for k,v in pairs(atmList) do
		exports["target"]:AddCircleZone("Eletronics:"..k,vector3(v[1],v[2],v[3]),0.75,{
			name = "Eletronics:"..k,
			heading = 337.41
		},{
			shop = k,
...
AddEventHandler("eletronics:openSystem",function(shopId)
	if atmList[shopId][5] == "Sul" then
		...
		TriggerEvent("Notify","amarelo","Número de Policiais insuficientes no momento.",5000)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADCANCEL
