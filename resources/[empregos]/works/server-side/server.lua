...
local works = {
	["Transportador"] = {
		...
		["upgradeStress"] = 1,
		["ferramenta"] = "WEAPON_HATCHET",
		["ferramentaindex"] = "Machado",
		["routeCollect"] = false,
		["routeDelivery"] = true,
	...
	["Minerador"] = {
		...
		["upgradeStress"] = 3,
		["ferramenta"] = "WEAPON_HAMMER",
		["ferramentaindex"] = "Martelo",
		["routeCollect"] = false,
		["routeDelivery"] = false,
		["usingVehicle"] = false,
		["collectRandom"] = true,
...
function cRP.collectConsume(serviceName)
	...
	if user_id then
		if GetSelectedPedWeapon(ped) == GetHashKey(works[serviceName]["ferramenta"]) or serviceName == "Transportador" or serviceName == "Colheita" or serviceName == "Mergulhador" or serviceName == "AgricultorTrigo" or serviceName == "Motorista" then
			...
			TriggerClientEvent("Notify",source,"vermelho","Necessita de um "..works[serviceName]["ferramentaindex"]..".",5000)
		end
	end
