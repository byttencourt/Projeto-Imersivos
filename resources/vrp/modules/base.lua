...
-- DISCORDHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webHook = "https://discord.com/api/webhooks/973091118403182702/QmPMh6Solhpqe2gGUdBq9xm0dn3S-jXEKSPczOzcZF9gWVpZXVpN7T4oQ-psSPIYx9w8"
-----------------------------------------------------------------------------------------------------------------------------------------
-- MYSQL
-----------------------------------------------------------------------------------------------------------------------------------------
local mysqlDriver
...
Citizen.CreateThread( function()
	while true do
		...
		print("^4["..os.date("%H:%M:%Sh").."] ^3Todo o conteúdo de tabelas foi ^2salvo^3 no banco de dados com sucesso.^0")
	end
end)
	...
	if source == 0 then
		...
		if user_id then
			if vRP.hasPermission(user_id,"Admin") then
				...
				TriggerClientEvent("Notify",source,"sucesso","Todo o conteúdo do banco de dados foi salvo.",5000)
			end
		end
	end
end)
			...
			if whitelistEnabled then
				if infoAccount then
					if infoAccount["whitelist"] then
						...
						deferrals.done("Faça whitelist em https://discord.gg/imersivos sua SteamHex: "..steam)
					end
				else
