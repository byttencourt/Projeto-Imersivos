...
-- SETPREMIUM7
-----------------------------------------------------------------------------------------------------------------------------------------
function vRP.setPremium7(user_id)
	vRP.execute("accounts/setPremium",{ steam = vRP.userInfos[user_id]["steam"], premium = os.time() + 604800, priority = 50 })

	if vRP.userInfos[user_id] then
		vRP.userInfos[user_id]["premium"] = parseInt(os.time() + 604800)
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- UPGRADEPREMIUM
...
-- UPGRADEPREMIUM7
-----------------------------------------------------------------------------------------------------------------------------------------
function vRP.upgradePremium7(user_id)
	vRP.execute("accounts/updatePremium2",{ steam = vRP.userInfos[user_id]["steam"] })

	if vRP.userInfos[user_id] then
		vRP.userInfos[user_id]["premium"] = vRP.userInfos[user_id]["premium"] + 604800
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- USERPREMIUM
