...
-----------------------------------------------------------------------------------------------------------------------------------------
local blackWeapons = {
	"weapon_raypistol","weapon_grenade","weapon_bzgas","weapon_molotov","weapon_stickybomb","weapon_proxmine",
	"weapon_pipebomb","weapon_ball","weapon_rayminigun","weapon_hominglauncher","weapon_firework","weapon_minigun",
