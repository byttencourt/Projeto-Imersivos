    ...
    switch (event.data.action) {
        ...
        case 'multas_page':
            ...
            $('#sidebar').html(`
				...
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Salario</span></p>
				${society}
			`);
            ...
            for (var i = 0; i < num; i++) {
                ...
                amount = `<td class="align-middle pay-invoice" data-id-key="${db.id}" data-price-key="${db.price}" style="font-weight: 500;"><span style="color: #2ecc71; float: right;"> ${db.price.toLocaleString()}</span> </td>`;
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						<tr>
							<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								To <span style="color: #377c31;">Arthur James</span>
								<div style="margin-top: -5px;">Enviado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500;">- 732 500$</td>
						...
						<tr>
							<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Em <span style="color: #377c31;">Bank Account</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500; color: #2ecc71;">+ 57 000$</td>
        ...
        case 'transactions_page':
            ...
            for (var i = 0; i < num; i++) {
                ...
                if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
                    icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								De <span style="color: #377c31; font-weight: 600;">${db.sender_name}</span>
                    ...
                    icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #377c31; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Enviado</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()}$</span> </td>`;
                    // Deposited
                    ...
                    icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
                    data = `<td class="align-middle" style="font-weight: 500;">
								Em <span style="color: #377c31; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Depositado</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71; float: right;">+ ${db.value.toLocaleString()}$</span> </td>`;
                    // Withdrawn
            ...
            $('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #377c31; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">TRANSAÇÕES</h6>
						    <p class="card-text" id="totalInvoices" style="font-size: 20px;">${numOfTransactions}</p>
						  </div>
...
$(document).on('click', "#overview_page", function() {
    $.post('https://SosaBank/action', JSON.stringify({
...
$(document).on('click', ".pay-invoice", function() {
    let $el = $('.pay-invoice');
    $.post("http://SosaBank/invoicesPayment", JSON.stringify({
...
$(document).on('click', ".pay-fine", function() {
    let $el = $('.pay-fine');
    $.post("http://SosaBank/finesPayment", JSON.stringify({
        id: $el.attr('data-id-key'),
        price: $el.attr('data-price-key')
    }));
});
...
function overview_page_function(event) {
    ...
    gradient.addColorStop(0, 'rgba(12, 143, 71, 0.5)');
    gradient.addColorStop(1, 'rgba(12, 143, 71)');
					...
					<div class="">
						<div class="row">
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #2e6829; border-radius: 10px; color: #fff;">
