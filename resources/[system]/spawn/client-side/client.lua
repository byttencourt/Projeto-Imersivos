...
-----------------------------------------------------------------------------------------------------------------------------------------
local otherLocates = {
	{ 55.28,-880.61,30.35,"Garagem Praça" },
	{ -284.13,6234.48,31.49,"Paleto Boulevard" },
	{ 1937.02,3721.35,32.71,"Sandy Shores" },
	--{ 1858.94,3741.78,33.09,"Armadillo Avenue" },
	{ 1138.42,2671.76,38.1,"Hotel Route 68" },
--	{ -773.27,296.75,85.71,"Hotel Milton Drive" },
--	{ 449.71,-659.27,28.48,"Integrity Way" },
	{ -27.17,-146.3,56.97,"Salão / Barbearia" }
}
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("spawn:justSpawn",function(status,spawnType)
	...
	if spawnType then
		...
		for k,v in pairs(status) do
			...
			if k == "Modern" then
				Locate[numberLine] = { x = v[1], y = v[2], z = v[3], name = "Hotel Eclipse Towers", hash = numberLine }
			else
