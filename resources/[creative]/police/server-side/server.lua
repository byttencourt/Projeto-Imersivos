...
local preset = {
	["mp_m_freemode_01"] = {
		...
		["pants"] = { item = 126, texture = 4 },
		["vest"] = { item = 0, texture = 0 },
		["bracelet"] = { item = -1, texture = 0 },
		["decals"] = { item = 25, texture = 0 },
		["mask"] = { item = 0, texture = 0 },
		["shoes"] = { item = 38, texture = 13 },
		["tshirt"] = { item = 15, texture = 0 },
		["torso"] = { item = 144, texture = 0 },
	...
	["mp_f_freemode_01"] = {
		["hat"] = { item = -1, texture = 0 },
		["pants"] = { item = 89, texture = 4 },
		["vest"] = { item = 0, texture = 0 },
		["bracelet"] = { item = -1, texture = 0 },
		["decals"] = { item = 26, texture = 0 },
		["mask"] = { item = 0, texture = 0 },
		["shoes"] = { item = 19, texture = 13 },
		["tshirt"] = { item = 14, texture = 0 },
		["torso"] = { item = 129, texture = 0 },
		["accessory"] = { item = 0, texture = 0 },
		["watch"] = { item = -1, texture = 0 },
...
function cRP.reducePrison()
	...
	if user_id then
		...
		if parseInt(identity["prison"]) <= 0 then
			...
			TriggerEvent("discordLogs","Penitenciaria","Passaporte **"..user_id.."**. Cumpriu sua pena, a liberdade cantou!",3092790)
		else
			vCLIENT.asyncServices(source)
			TriggerClientEvent("Notify",source,"azul","Restam <b>"..parseInt(identity["prison"]).." serviços</b>.",5000)
			TriggerEvent("discordLogs","Penitenciaria","Passaporte **"..user_id.."**. Está cumprindo pena, resta(m) **"..parseInt(identity["prison"]).." serviços**.",3092790)
		end
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
