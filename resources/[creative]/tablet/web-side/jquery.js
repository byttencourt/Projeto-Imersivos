...
const benefactor = (mode) => {
	...
	$("#content").html(`
		<div id="benefactorBar">
			...
			<li id="benefactor" data-id="Aluguel" ${mode == "Aluguel" ? "class=active":""}>VEÍCULOS ALUGUEL</li>
		</div>
	...
	$.post("http://tablet/request"+ mode,JSON.stringify({}),(data) => {
		...
		if (mode !== "Possuidos"){
			$("#pageVehicles").html(`
				...
				<img src="http://191.96.78.187/images/cars/${item.k}.png" style="margin-left: 2vw; margin-top: 1vw; width: 10vw; height: 6vw;">
					<left>
						<i>${item["name"]}</i>
