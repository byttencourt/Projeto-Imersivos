...
local preset = {
	...
	["2"] = {
		["mp_m_freemode_01"] = {
			["hat"] = { item = -1, texture = 0 },
			["pants"] = { item = 89, texture = 2 },
			["vest"] = { item = 0, texture = 0 },
			["bracelet"] = { item = -1, texture = 0 },
			["backpack"] = { item = 0, texture = 0 },
			["decals"] = { item = 0, texture = 0 },
			["mask"] = { item = 60, texture = 0 },
			["shoes"] = { item = 6, texture = 0 },
			["tshirt"] = { item = 15, texture = 0 },
			["torso"] = { item = 90, texture = 0 },
			["accessory"] = { item = 0, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
			["arms"] = { item = 171, texture = 3 },
			["glass"] = { item = 0, texture = 0 },
			["ear"] = { item = -1, texture = 0 }
		},
		["mp_f_freemode_01"] = {
			...
			["bracelet"] = { item = -1, texture = 0 },
			["backpack"] = { item = 0, texture = 0 },
			["decals"] = { item = 00, texture = 0 },
			["mask"] = { item = 30, texture = 0 },
			["shoes"] = { item = 119, texture = 0 },
			["tshirt"] = { item = 14, texture = 0 },
			["torso"] = { item = 520, texture = 3 },
			["accessory"] = { item = 0, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
