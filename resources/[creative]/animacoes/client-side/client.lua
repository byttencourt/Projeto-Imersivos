...
-----------------------------------------------------------------------------------------------------------------------------------------
local animacoes = {
	["esquentar2"] = { dict = "amb@world_human_stand_fire@male@base", anim = "base", andar = false, loop = true },
	...
	["mamadeira"] = { dict = "amb@world_human_aa_coffee@idle_a", anim = "idle_a", prop = "mah_mamadeira", flag = 49, hand = 28422 },
	...
	["parachoque"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "imp_prop_impexp_front_bumper_02a", flag = 49, mao = 28422, altura = -0.02, pos1 = -0.1, pos2 = 0.2, pos3 = 10.0, pos4 = 0.0, pos5 = 0.0 },
	["capo"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_hood", flag = 49, mao = 28422, altura = 0.0, pos1 = -0.1, pos2 = -0.15, pos3 = 00.0, pos4 = 0.0, pos5 = 0.0 },
	["porta"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_door_01", flag = 49, mao = 28422, altura = 0.0, pos1 = -0.1, pos2 = -0.15, pos3 = 00.0, pos4 = 0.0, pos5 = 0.0 },
	["porta2"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_door_02", flag = 49, mao = 28422, altura = 0.0, pos1 = -0.1, pos2 = -0.15, pos3 = 00.0, pos4 = 0.0, pos5 = 0.0 },
	["porta3"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_door_03", flag = 49, mao = 28422, altura = 0.0, pos1 = -0.1, pos2 = -0.15, pos3 = 00.0, pos4 = 0.0, pos5 = 0.0 },
	["porta4"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_door_04", flag = 49, mao = 28422, altura = 0.0, pos1 = -0.1, pos2 = -0.15, pos3 = 00.0, pos4 = 0.0, pos5 = 0.0 },
	["banco"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_seat", flag = 49, mao = 28422, altura = 0.0, pos1 = -0.2, pos2 = -0.14, pos3 = 00.0, pos4 = 0.0, pos5 = 0.0 },
	["pneu2"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_wheel_03", flag = 49, mao = 28422, altura = -0.02, pos1 = -0.1, pos2 = 0.2, pos3 = 10.0, pos4 = 0.0, pos5 = 0.0 },
	["bateria"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_battery_01", flag = 49, mao = 28422, altura = 0.0, pos1 = -0.1, pos2 = -0.10, pos3 = 00.0, pos4 = 0.0, pos5 = 0.0 },
	...
	["cruzar4"] = { dict = "anim@amb@casino@hangout@ped_male@stand@02b@idles", anim = "idle_a", andar = true, loop = true },
	["cruzar5"] = { dict = "amb@world_human_cop_idles@female@idle_b", anim = "idle_e", andar = true, loop = true },
	...
	["pose1"] = { dict = "syx@cute01", anim = "cute01", andar = false, loop = true },
	["pose2"] = { dict = "syx@cute02", anim = "cute02", andar = false, loop = true },
	["pose3"] = { dict = "syx@cute03", anim = "cute03", andar = false, loop = true },
	["pose4"] = { dict = "syx@cute04", anim = "cute04", andar = false, loop = true },
	["pose5"] = { dict = "syx@cute05", anim = "cute05", andar = false, loop = true },
	["pose6"] = { dict = "lunyx@random@v3@pose001", anim = "random@v3@pose001", andar = false, loop = true },
	["pose7"] = { dict = "lunyx@random@v3@pose002", anim = "random@v3@pose002", andar = false, loop = true },
	["pose8"] = { dict = "lunyx@random@v3@pose003", anim = "random@v3@pose003", andar = false, loop = true },
	["pose9"] = { dict = "lunyx@random@v3@pose004", anim = "random@v3@pose004", andar = false, loop = true },
	["pose10"] = { dict = "lunyx@random@v3@pose005", anim = "random@v3@pose005", andar = false, loop = true },
	["pose11"] = { dict = "lunyx@random@v3@pose006", anim = "random@v3@pose006", andar = false, loop = true },
	["pose12"] = { dict = "lunyx@random@v3@pose007", anim = "random@v3@pose007", andar = false, loop = true },
	["pose13"] = { dict = "lunyx@random@v3@pose008", anim = "random@v3@pose008", andar = false, loop = true },
	["pose14"] = { dict = "lunyx@random@v3@pose009", anim = "random@v3@pose009", andar = false, loop = true },
	["pose15"] = { dict = "lunyx@random@v3@pose010", anim = "random@v3@pose010", andar = false, loop = true },
	["pose16"] = { dict = "lunyx@random@v3@pose011", anim = "random@v3@pose011", andar = false, loop = true },
	["pose17"] = { dict = "lunyx@random@v3@pose012", anim = "random@v3@pose012", andar = false, loop = true },
	["pose18"] = { dict = "lunyx@random@v3@pose013", anim = "random@v3@pose013", andar = false, loop = true },
	["pose19"] = { dict = "lunyx@random@v3@pose014", anim = "random@v3@pose014", andar = false, loop = true },
	["pose20"] = { dict = "lunyx@random@v3@pose015", anim = "random@v3@pose015", andar = false, loop = true },
	["pose21"] = { dict = "lunyx@random@v3@pose016", anim = "random@v3@pose016", andar = false, loop = true },
	["pose22"] = { dict = "lunyx@random@v3@pose017", anim = "random@v3@pose017", andar = false, loop = true },
	["pose23"] = { dict = "lunyx@random@v3@pose018", anim = "random@v3@pose018", andar = false, loop = true },
	["pose24"] = { dict = "lunyx@random@v3@pose019", anim = "random@v3@pose019", andar = false, loop = true },
	["pose25"] = { dict = "lunyx@random@v3@pose020", anim = "random@v3@pose020", andar = false, loop = true },
	["pose26"] = { dict = "lunyx@rgmp01", anim = "rgmp01", andar = false, loop = true },
	["pose27"] = { dict = "lunyx@rgmp02", anim = "rgmp02", andar = false, loop = true },
	["pose28"] = { dict = "lunyx@rgmp03", anim = "rgmp03", andar = true, loop = true },
	["pose29"] = { dict = "lunyx@rgmp04", anim = "rgmp04", andar = false, loop = true },
	["pose30"] = { dict = "lunyx@rgmp05", anim = "rgmp05", andar = false, loop = true },
	["pose31"] = { dict = "lunyx@rgmp06", anim = "rgmp06", andar = false, loop = true },
	["pose32"] = { dict = "lunyx@rgmp07", anim = "rgmp07", andar = false, loop = true },
	["pose33"] = { dict = "arron@simspose1", anim = "simspose1", andar = false, loop = true },
	["pose34"] = { dict = "arron@simspose2", anim = "simspose2", andar = false, loop = true },
	["pose35"] = { dict = "arron@simspose3", anim = "simspose3", andar = false, loop = true },
	["pose36"] = { dict = "arron@simspose4", anim = "simspose4", andar = false, loop = true },
	["pose37"] = { dict = "arron@simspose5", anim = "simspose5", andar = false, loop = true },
	
	
	-------------CASAL POSE---------
	
	["casal1"] = { dict = "holdhip@animation", anim = "holdhip_clip", andar = false, loop = true },
	["casal2"] = { dict = "holdhipb@animation", anim = "holdhipb_clip", andar = false, loop = true },
	["casal3"] = { dict = "holdass@animation", anim = "holdass_clip", andar = false, loop = true },
	["casal4"] = { dict = "holdassb@animation", anim = "holdassb_clip", andar = false, loop = true },
	["casal5"] = { dict = "coupleseat1@animation", anim = "coupleseat1_clip", andar = false, loop = true },
	["casal6"] = { dict = "coupleseat1b@animation", anim = "coupleseat1b_clip", andar = false, loop = true },
	["casal7"] = { dict = "dollie_mods@follow_me_001", anim = "follow_me_001", andar = false, loop = true },
	["casal8"] = { dict = "dollie_mods@follow_me_002", anim = "follow_me_002", andar = false, loop = true },
	["casal9"] = { dict = "mx@couplemale", anim = "clipcouple_male", andar = false, loop = true },
	["casal10"] = { dict = "mx@couplefemale", anim = "clipcouple_female", andar = false, loop = true },
	["casal11"] = { dict = "karxem@couple_f", anim = "karxem_couple_f_clip", andar = false, loop = true },
	["casal12"] = { dict = "karxem@couple_m", anim = "karxem_couple_m_clip", andar = false, loop = true },
	["casal13"] = { dict = "karxem@couple2_f", anim = "karxem_coupel2_f_clip", andar = false, loop = true },
	["casal14"] = { dict = "karxem@couple2_m", anim = "karxem_couple2_m_clip", andar = false, loop = true },
	["casal15"] = { dict = "karxem@couple3_f", anim = "karxem_couple3_f_clip", andar = false, loop = true },
	["casal16"] = { dict = "karxem@couple3_m", anim = "karxem_couple3_m_clip", andar = false, loop = true },
	-----------------------------------
	----------HOMEMPOSE---------
	----------------------------------
	["poseh1"] = { dict = "anim@sw_sit_chill", anim = "sit_chill_clip", andar = false, loop = true },
	["poseh2"] = { dict = "anim@sw_chill_pose", anim = "chill_pose_clip", andar = false, loop = true },
	["poseh3"] = { dict = "mx@pose1", anim = "mx_animclip1", andar = false, loop = true },
	["poseh4"] = { dict = "mx@pose2", anim = "mx_clippose2", andar = false, loop = true },
	["poseh5"] = { dict = "mx@pose3", anim = "mx_clippose3", andar = false, loop = true },
	["poseh6"] = { dict = "mx@pose4", anim = "mx_clippose4", andar = false, loop = true },
	------------------------------------
	--------Selfie-----------
	----------------------------------
	["selfie3"] = { dict = "anim@fuck_you_selfie", anim = "fuck_you_selfie_clip", andar = false, loop = true },
	["selfie4"] = { dict = "thot_pose", anim = "thot_clip", andar = false, loop = true },
    ...
    ["tiktok18"] = { dict = "custom@armswirl", anim = "armswirl", andar = false, loop = true },
    ["tiktok19"] = { dict = "custom@armwave", anim = "armwave", andar = false, loop = true },
    ["tiktok20"] = { dict = "custom@circle_crunch", anim = "circle_crunch", andar = false, loop = true },
    ["tiktok21"] = { dict = "custom@dig", anim = "dig", andar = false, loop = true },
    ["tiktok22"] = { dict = "custom@gangnamstyle", anim = "gangnamstyle", andar = false, loop = true },
    ["tiktok23"] = { dict = "custom@makarena", anim = "makarena", andar = false, loop = true },
    ["tiktok24"] = { dict = "custom@maraschino", anim = "maraschino", andar = false, loop = true },
    ["tiktok25"] = { dict = "custom@pickfromground", anim = "pickfromground", andar = false, loop = true }, --- pegar no chao
    ["tiktok26"] = { dict = "custom@salsa", anim = "salsa", andar = false, loop = true },
    ["tiktok27"] = { dict = "custom@what_idk", anim = "what_idk", andar = false, loop = true },
